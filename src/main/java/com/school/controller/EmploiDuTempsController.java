...
public class EmploiDuTempsController {
    ...
    @DeleteMapping("/emplois-du-temps/{id}") public ResponseEntity<Map<String,Object>> delete(@PathVariable Long id){svc.delete(id);return ResponseEntity.ok(Map.of("message","EDT supprimé","id",id));}
